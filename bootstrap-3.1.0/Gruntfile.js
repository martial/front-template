  ...
  grunt.initConfig({
    ...
    less: {
      compileCore: {
        ...
        files: {
          '../public/css/<%= pkg.name %>.css': 'less/bootstrap.less'
        }
      },
      compileTheme: {
        options: {
        ...
        files: {
          '../public/css/<%= pkg.name %>-theme.css': 'less/theme.less'
        }
      },
      minify: {
        options: {
        ...
        files: {
          ...
          '../public/css/<%= pkg.name %>-theme.min.css': '../public/css/<%= pkg.name %>-theme.css'
        }
      }
    },
      ...
      dist: {
        ...
        files: {
          src: [
            ...
            '../public/css/<%= pkg.name %>-theme.css',
            '../public/css/<%= pkg.name %>-theme.min.css'
          ]
        }
      }
    },
    ...
    csscomb: {
      sort: {
        ...
        files: {
          ...
          '../public/css/<%= pkg.name %>-theme.css': '../public/css/<%= pkg.name %>-theme.css'
        }
      }
    },
